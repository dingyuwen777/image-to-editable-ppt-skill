...
class WebBuildPipelineTest(unittest.TestCase):
    ...
    def test_builds_records_valid_pages_and_finalizes_deck(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertTrue((run / "pages/page_001/page.pptx").is_file())
            self.assertTrue((run / "pages/page_001/preview.png").is_file())
            self.assertTrue((run / "pages/page_001/split_assets_contact.png").is_file())
